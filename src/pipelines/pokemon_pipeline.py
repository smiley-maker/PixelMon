...
from src.model_architectures.VAE.model.vae_model import VAE_Model
...
def show_images_grid(images, title='Sampled Images'):
  '''
...
if __name__ == "__main__":
    ...
    trainer = TrainVAE(
        ...
        xdim=(3,120,120),
        device=device,
        write_results="src/results/training/200epochs_none",
        save_images=True,
    )

    trainer.train_model()

#    torch.save(model, "src/results/models/pixelmonbw20000epochs.pt")
